"""Panel UI for Manhattan Associates WMS Connector following UI_INTERFACE_STANDARD.md."""
...
def _help_modal() -> ui.UINode:
    return ui.Modal(
        ...
        children=[
            ui.Text(
                "1. Sign in to your Manhattan Associates WMS dashboard and navigate to API/Integration settings.\n"
...
async def main_panel(ctx) -> ui.UINode:
    ...
    return ui.Stack(
        ...
        gap=2,
        children=[
            ui.Heading("Manhattan Associates WMS Connector", level=3),
            ui.Text("Connect and manage your Manhattan Associates WMS workspace.", variant="caption"),
            ui.Divider(),
            form,
            ui.Divider(),
            _help_modal(),
