"""HTTP client for Manhattan Associates WMS (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.manhattan_wms.com"

class ManhattanAssociatesWMSClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-manhattan_wms/0.1.0"
        }
