# PST Testing Scenarios for Manhattan Active WMS Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_manhattan_associates_wms_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_manhattan_associates_wms_connector` without lingering secrets.
