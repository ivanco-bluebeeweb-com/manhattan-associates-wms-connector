"""Pydantic schemas for Manhattan Associates WMS Connector (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
from typing import Any, Optional
from pydantic import BaseModel, Field

class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Acme Manhattan Associates WMS.")
