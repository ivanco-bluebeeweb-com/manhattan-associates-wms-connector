"""Settings panel for Manhattan Associates WMS Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__manhattan_wms_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=manhattan_wms_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_manhattan_wms"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Manhattan Associates WMS Settings & Accounts", level=2),
